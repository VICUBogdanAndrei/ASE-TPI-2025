function []= contrast_liniar(nume, r, s, tip)
    ...
    % Exemple de apel: 
    % doua puncte
    % contrast_liniar('Lenna_mono.bmp',[0 84 170 255], [0 40 210 255], 'png');
    % contrast_liniar('MB.jpg',[0 84 170 255], [0 40 210 255], 'png');
    % patru puncte
    % contrast_liniar('Lenna_mono.bmp',[0 42 85 127 169 212 255], [0 30 65 127 189 232 255], 'png');
    ...
    imwrite(uint8(rez),[doarnume '-cl.' tip],tip);
end
